...
export { Chair } from '../icons/category/chair';
export { Bed } from '../icons/category/bed';
export { Bookshelf } from '../icons/category/book-shelf';
export { CenterTable } from '../icons/category/center-table';
export { DressingTable } from '../icons/category/dressing-table';
export { ReadingTable } from '../icons/category/reading-table';
export { Sofa } from '../icons/category/sofa';
...
export { Table } from '../icons/category/table';
