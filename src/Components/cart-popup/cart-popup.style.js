...
const PlaceOrderBox = styled('span')`
  width: 100px;
  height: 56px;
  overflow: hidden;
  border-radius: 28px;
  ...
  align-items: center;
  justify-content: center;
  background-color: ${themeGet('colors.bule', '#006400')};
  font-family: ${themeGet('fonts.body', 'sans-serif')};
  font-size: ${themeGet('fontSizes.xs', '14')}px;
  font-weight: ${themeGet('fontWeights.bold', '800')};
  color: ${themeGet('colors.primary.white', '#FFFFFF')};
  margin-right: 2px;
