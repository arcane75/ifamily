...
import MobileBanking from './image/mobile_banking.png';
...
const RadioCard = ({
  ...
  return (
    ...
    >
      ...
      <CardContent>
        {id == '1' &&
          <span><img src={CashonDelivery} alt={`card-${id}`} /></span>
        }
        {id == '2' &&
          <>
            <span><img src={MasterCard} alt={`card-${id}`} /></span>&nbsp;&nbsp;
            <span><img src={Visa} alt={`card-${id}`} /></span>
          </>
        }
        {id == '3' &&
          <span><img src={MobileBanking} alt={`card-${id}`} /></span>
        }
